...
<section class="add-products">
   ...
   <form action="" method="POST" enctype="multipart/form-data">
      ...
      <input type="text" required placeholder="entrez le nom du produit" name="name" maxlength="100" class="box">
      <input type="number" min="0" max="9999999999" required placeholder="saisir le prix du produit" name="price" onkeypress="if(this.value.length == 10) return false;" class="box">

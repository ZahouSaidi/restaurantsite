...
if(isset($_POST['submit'])){
   ...
   if($select_user->rowCount() > 0){
      $message[] = 'l\'email ou le numéro existe déjà !';
   }else{
      if($pass != $cpass){
...
<section class="form-container">
   ...
   <form action="" method="post">
      ...
      <input type="password" name="cpass" required placeholder="confirmer votre mot de passe" class="box" maxlength="50" oninput="this.value = this.value.replace(/\s/g, '')">
